    ...
    <div className="mx-auto max-w-[1440px] lg:p-[16px]">
      ...
      >
        ...
        <div className="w-[292px] max-w-[292px] lg:pr-[16px]">
          <div className="mb-[24px] text-[16px] leading-[24px] text-white opacity-[0.32]">
            МЕНЮ
          </div>
          <nav className="flex flex-col gap-[12px]">
            <NavLink
              to="/"
              className="text-[16px] leading-[24px] text-white opacity-100 hover:opacity-[0.64]"
            >
        ...
        <div className="w-[292px] max-w-[292px] lg:pr-[16px]">
          ...
          <div className="mb-[8px]">
            <a
              href="tel:+7 495 006 21 57"
              className="text-[24px] font-bold leading-[32px] text-white opacity-100 hover:opacity-[0.64]"
            >
              +7 495 006 21 57
            </a>
          </div>
          <div className="mb-[20px]">
            <a
              href="mailto:info@roots.ru"
              className="text-[24px] font-bold leading-[32px] text-white opacity-100 hover:opacity-[0.64]"
            >
              info@roots.ru
            </a>
          </div>
          <button className="button-footer" onClick={handleFeedbackClick}>
            Написать нам
          </button>
        </div>
      </footer>
